...
function Projectcard({ project, handleDelete, setEditProject, projectPics }) {
      ...
      <div className="p-2 card w-100">
        ...
        <div className="d-flex flex-row justify-content-center m-auto">
          <button onClick={focusProject} className="btn m-1 btn-secondary">
            <NavLink className="nlink" to="/Customerprojects/Additems">
              Add Items
            </NavLink>
          </button>
          <button onClick={focusProject} className="btn m-1 btn-secondary">
            <NavLink className="nlink" to="/Customerprojects/Edititems">
              Edit Quantity
            </NavLink>
          </button>
          <button
